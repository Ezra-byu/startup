...
const { peerProxy } = require('./peerProxy.js'); //added for websocket
...
apiRouter.post('/auth/create', async (req, res) => {
  console.log("/auth/create api called")
...
// SubmitCharacter
secureApiRouter.post('/characters', async(req, res) => {
...
// GetCharacter
secureApiRouter.get('/characters', (_req, res) => {
  console.log('in get request')
  res.send(queue); // Is this correct?
});

//getCharacterCount
secureApiRouter.get('/count', async (_req, res) => {
